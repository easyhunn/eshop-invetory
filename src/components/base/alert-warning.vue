  ...
  <div class="alert-error">
    ...
    <div class="alert-container">
      <div class="alert-header">
        ...
        <button @click="this.closeAlert" class="d-icon icon-x"></button>
      </div>
      <div class="alert-content">
        <div class="d-icon icon-popup-warning m-icon"></div>
        <div class="alert-message">
          Mã SKU <b>{{SKUCode}}</b> khai báo cho nhiều hàng hóa. Vui lòng kiểm tra lại
        </div>
      </div>
      <div class="alert-footer">
        <div class="alert-group-button">
          <button class="button-default btn-red" @click="closeAlert">
            <div class="d-text">Đồng ý</div>
          </button>
        </div>
      </div>
    </div>
